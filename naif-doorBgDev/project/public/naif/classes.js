...
class Door {
    ...
    copyContent() {
        push();
        copy(this.g, int(this.x) - int(doorW), int(this.y - doorH), int(doorW), int(doorH), int(this.x - doorW / 2), int(this.y - doorH), int(doorW), int(doorH));
        pop();
    }
}
...
class MultiDoor {
    ...
    copyContent() {
        ...
        let doorWb = this.w;
        let doorHb = this.h;
        copy(this.g, this.x - int(doorWb), int(this.y - doorHb), int(doorWb), int(doorHb), int(this.x - doorWb / 2), int(this.y - doorHb), int(doorWb), int(doorHb));
        pop();
    }
}
